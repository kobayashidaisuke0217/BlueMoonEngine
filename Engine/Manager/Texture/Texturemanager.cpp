...
uint32_t TextureManager::LoadTexture(const std::string& filePath)
{
	...
	textureIndex = SrvDescriptorHeap::GetInstance()->Allocate();
	...
	//SRVの生成
	SrvDescriptorHeap::GetInstance()->CreateSRVForTexture2D(
...
{
	SrvDescriptorHeap::GetInstance()->SetGraphicsRootDescriptorTable(2, texHandle);
}
